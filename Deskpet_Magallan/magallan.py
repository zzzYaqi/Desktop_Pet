...
class MainWindows(QWidget):
    def __init__(self):
        ...
        # 当前宠物
        self.resource='Deskpet_Magallan\\magallan'
        ...
        self.up_bound = -200
        self.down_bound = win32api.GetSystemMetrics(win32con.SM_CYSCREEN)-240
    ...
    def menu_init(self):
        ...
        quit_action.setIcon(QIcon('magallan\\0.png'))  # 设置右键点开时左边的图片
    ...
    def tray_init(self):
        ...
        self.tray_icon.setIcon(QIcon('magallan\\0.png'))  # 托盘图案
